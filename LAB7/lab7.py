...
vehicles = [
    ...
    Car("C1", "BMW", 2025, "Electric", 4),
    Car("C2", "Fiat", 2015, "Petrol", 2),

    Truck("T1", "Ford", 2024, 5000, 4),
    Truck("T2", "Scan", 2010, 8000, 6),

    Motorcycle("M1", "Honda", 2026, 600, "Sport"),
    Motorcycle("M2", "Yamaha", 2020, 250, "Dirt")
]
